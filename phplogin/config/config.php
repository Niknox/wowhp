...
define("COOKIE_DOMAIN", '.xserv.net'); // to be replaced by '.mydomain.com'
define("COOKIE_SECRET_KEY", "L}JYv(Hhb3+[7A%eSSrD;Pz=");
 ...
 */
define("EMAIL_PASSWORDRESET_FROM", "no-reply@xserv.net");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Xserv WoW");
define("EMAIL_PASSWORDRESET_SUBJECT", "Passwort zurücksetzen");
define("EMAIL_PASSWORDRESET_CONTENT", "Bitte klicke auf diesen Link um dein Passwort zurückzusetzen:");

/**
 * Configuration for: verification email data
 */
define("EMAIL_VERIFICATION_FROM", "no-reply@xserv.net");
define("EMAIL_VERIFICATION_FROM_NAME", "Xserv WoW");
define("EMAIL_VERIFICATION_SUBJECT", "Accountaktivierung");
define("EMAIL_VERIFICATION_CONTENT", "Bitte klicke auf diesen Link um dein Account zu aktivieren:");
...
define("ALLOW_ADMIN_TO_REGISTER_NEW_USER", false);
