...
<?php echo (ALLOW_USER_REGISTRATION ? '<a class="phplogin" href="?register">'. WORDING_REGISTER_NEW_ACCOUNT .'</a>&nbsp;&nbsp;|&nbsp;&nbsp;' : ''); ?>
<a class="phplogin" href="?password_reset"><?php echo WORDING_FORGOT_MY_PASSWORD; ?></a>
