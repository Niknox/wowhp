...
<fieldset>
	<legend><?php echo WORDING_PROFILE; ?></legend>
...
<a href="?logout"><?php echo WORDING_LOGOUT; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="phplogin" href="?edit"><?php echo WORDING_EDIT_USER_DATA; ?></a>
<?php echo (ALLOW_ADMIN_TO_REGISTER_NEW_USER && $_SESSION['user_access_level'] == 255 ? '<br/><a class="phplogin" href="?register">'. WORDING_REGISTER_NEW_ACCOUNT .'</a>' : ''); ?>
