...
define("WORDING_CURRENTLY", "derzeitige Adresse");
...
define("WORDING_NEW_USERNAME", "Neuer Benutzername (Benutzername darf nur a-z,A-Z,0-9 enthalten und muss 3-20 Zeichen lang sein)");
define("WORDING_OLD_PASSWORD", "Altes Passwort");
define("WORDING_PASSWORD", "Passwort");
define("WORDING_PROFILE", "Dein Profil");
define("WORDING_PROFILE_PICTURE", "Dein Profilbild (von Gravatar):");
define("WORDING_REGISTER", "Registrieren");
define("WORDING_REGISTER_NEW_ACCOUNT", "Neuen Account erstellen");
define("WORDING_REGISTRATION_CAPTCHA", "Bitte gib diese Zeichen ein");
define("WORDING_REGISTRATION_EMAIL", "E-Mail-Adresse (bitte gib eine echte E-Mail Adresse an, du erhältst eine Verifizierungsmail mit einem Aktivierungslink)");
define("WORDING_REGISTRATION_PASSWORD", "Passwort (mind. 6 Zeichen!)");
define("WORDING_REGISTRATION_PASSWORD_REPEAT", "Passwort bestätigen");
define("WORDING_REGISTRATION_USERNAME", "Benutzername (nur Buchstaben und Zahlen, 3 bis 20 Zeichen)");
define("WORDING_REMEMBER_ME", "Angemeldet bleiben");
define("WORDING_REQUEST_PASSWORD_RESET", "Wenn du dein Passwort vergessen hast, kannst du dein Passwort hier zurücksetzen.<br />Solltest du auch deinen Accountnamen oder deine E-Mail vergessen haben, kontaktiere bitte einen Administrator.<br/><br />Benutzername oder E-Mail-Adresse:");
define("WORDING_RESET_PASSWORD", "Passwort zurücksetzen");
define("WORDING_SUBMIT_NEW_PASSWORD", "Neues Passwort zusenden");
